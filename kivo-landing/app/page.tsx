    ...
    <footer className="footer" aria-label="Footer">
      ...
      <div className="jobs">
        ...
        <div className="footer-nav">
          <a href="/features" style={{ textDecoration: 'underline' }}>Features</a>
      ...
      <div className="contact">
        ...
        <div className="headline contact-links">
          <a href="/download" style={{ textDecoration: 'underline' }}>Download for Windows</a>
          <span>boost your workflow*</span>
        </div>
